...
namespace BinaryKits.Zpl.Viewer.Symologies
{
    public static class MaxiCodeSymbology
    {
        ...
        private static readonly int[] ec10Poly = new int[] { 1, 31, 28, 39, 42, 57, 2, 3, 49, 44, 46 };
        private static readonly int[] ec20Poly = new int[] { 1, 23, 44, 11, 33, 27, 8, 22, 37, 57, 36, 15, 48, 22, 17, 38, 33, 31, 19, 23, 59 };
        private static readonly int[] ec28Poly = new int[] { 1, 22, 45, 53, 10, 41, 55, 35, 10, 22, 29, 23, 13, 61, 45, 34, 55, 40, 37, 46, 49, 34, 41, 9, 43, 7, 20, 11, 28 };
        ...
        private static readonly Dictionary<CodewordType, int[]> offsets = new Dictionary<CodewordType, int[]>() {
            { CodewordType.Right, new int[] { 0, -1, 30, 29, 59, 58 } },
            { CodewordType.Left, new int[] { 0, -1, 29, 28, 59, 58 } },
            { CodewordType.Down, new int[] { 0, 30, 29, 59, 89, 88 } }
        };

        private static readonly int[] orientationPatterns = new int[] {
            // mode mark
            28, 29,
            // top left
            276, 277, 306,
        ...
        private static readonly Codeword[] codewords = new Codeword[] {
            // primary message
            // 1-9
            new Codeword { type = CodewordType.Irregular, msb = 462, offsets = new int[] {0, 59, -180, -151, -120, -121} },
            new Codeword { type = CodewordType.Irregular, msb = 662, offsets = new int[] {0, -1, 30, 29, -25, 3} },
            new Codeword { type = CodewordType.Irregular, msb = 279, offsets = new int[] {0, -1, 29, 28, 85, 321} },
            new Codeword { type = CodewordType.Irregular, msb = 608, offsets = new int[] {0, -235, -236, -205, -206, -176} },
            new Codeword { type = CodewordType.Irregular, msb = 694, offsets = new int[] {0, -1, -144, -114, -115, -85} },
            new Codeword { type = CodewordType.Irregular, msb = 451, offsets = new int[] {0, 59, 179, 239, 213, 212} },
            new Codeword { type = CodewordType.Irregular, msb = 281, offsets = new int[] {0, -1, 29, 28, 24, 54} },
            new Codeword { type = CodewordType.Irregular, msb = 523, offsets = new int[] {0, -238, -239, -209, -179, -180} },
            new Codeword { type = CodewordType.Irregular, msb = 449, offsets = new int[] {0, 29, 60, 59, 15, 14} },
            // 10-20
        ...
        public static bool[] Encode(string content, int mode)
        {
            ...
            for (int idx = 0; idx < data.Count; idx++)
            {
                ...
                for (int i = 0; i < 6; i++)
                {
                    result[codeword.msb + offs[i]] = (data[idx] & (1 << 5 - i)) > 0;
                }
            }
        ...
        private static List<int> ComputeReadSolomon(List<int> data, int[] ecPoly)
        {
            ...
            List<int> dividend = new List<int>(data);
            dividend.AddRange(Enumerable.Repeat(0, ecLen));
            List<int> quotient = GF64PolynomalDivision(dividend, ecPoly);
