...
namespace BinaryKits.Zpl.Viewer.Helpers
{
    public static class StringHelper
    {
        ...
        private static Encoding GetCharset(InternationalFont internationalFont)
        {
            ...
            {
                case InternationalFont.UTF8: return Encoding.UTF8;
                case InternationalFont.UTF16_BE: return Encoding.BigEndianUnicode;
                case InternationalFont.UTF16_LE: return Encoding.Unicode;
                case InternationalFont.ZCP1250: return Encoding.GetEncoding(1250);
                case InternationalFont.ZCP1251: return Encoding.GetEncoding(1251);
                case InternationalFont.ZCP1252: return Encoding.GetEncoding(1252);
                case InternationalFont.ZCP1253: return Encoding.GetEncoding(1253);
                case InternationalFont.ZCP1254: return Encoding.GetEncoding(1254);
                case InternationalFont.ZCP1255: return Encoding.GetEncoding(1255);
                default: return Encoding.GetEncoding(850);
            }
        }
    }
}
