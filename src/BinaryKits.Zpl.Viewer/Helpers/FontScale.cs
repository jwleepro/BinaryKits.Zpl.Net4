...
namespace BinaryKits.Zpl.Viewer.Helpers
{
    ...
    {
        private static readonly FontScaleDictionary fontScales6mm = new FontScaleDictionary()
        {
            ["A"] = (9, 5),
            ["B"] = (11, 7),
            ["C"] = (18, 10),
        ...
        private static readonly FontScaleDictionary fontScales8mm = new FontScaleDictionary()
        {
            ["A"] = (9, 5),
            ["B"] = (11, 7),
            ["C"] = (18, 10),
        ...
        private static readonly FontScaleDictionary fontScales12mm = new FontScaleDictionary()
        {
            ["A"] = (9, 5),
            ["B"] = (11, 7),
            ["C"] = (18, 10),
        ...
        private static readonly FontScaleDictionary fontScales24mm = new FontScaleDictionary()
        {
            ["A"] = (9, 5),
            ["B"] = (11, 7),
            ["C"] = (18, 10),
